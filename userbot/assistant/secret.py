    ...
    if os.path.exists("./userbot/secrets.txt"):
        ...
        try:
            ...
            if event.query.user_id in ids:
                ...
                reply_pop_up_alert = "Bu xabarda sizga taaluqli narsa yo'q"
        except KeyError:
            reply_pop_up_alert = "Bu xabar serverda ortiq mavjud emas"
    else:
        reply_pop_up_alert = "Bu xabar ortiq mavjud emas "
